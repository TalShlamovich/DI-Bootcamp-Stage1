...
// let divs1 = document.getElementsByClassName('outer');
// console.log(divs1);
...
let ex1_1 = document.getElementById("page").firstElementChild;
console.log(ex1_1);

let ex1_1_b = document.getElementById("page").firstChild;
console.log(ex1_1_b);

let ex1_2_a = document.getElementById("page").lastElementChild;
console.log(ex1_2_a);

let ex1_2_b = document.getElementById("page").lastChild;
console.log(ex1_2_b);
